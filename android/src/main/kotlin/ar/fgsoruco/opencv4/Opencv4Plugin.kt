      ...
      "cartoonFilter" -> {
        try {
          CartoonFilterFactory.process(
                  ...
                  call.argument<Double>("lowEdge") as Double,
                  call.argument<Double>("highEdge") as Double,
                  call.argument<Int>("edgeKSize") as Int,
                  call.argument<Double>("maskThresholdValue") as Double,
                  call.argument<Double>("maskThresholdMaxValue") as Double,
                  call.argument<Int>("maskThresholdType") as Int,
                  call.argument<Int>("colorQuantizationDiameter") as Int,
                  call.argument<Int>("smoothlyDiameter") as Int,
                  call.argument<Double>("smoothlySigmaColor") as Double,
                  call.argument<Double>("smoothlySigmaSpace") as Double,
                  call.argument<Int>("smoothlyBorderType") as Int,
                  call.argument<ByteArray>("data") as ByteArray,
                  result)
        } catch (e: Exception) {
          result.error("OpenCV-Error", "Android: "+e.message, e)
